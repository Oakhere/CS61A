...
def count_coins(change):
    ...
    True
    """
    def count_coins_helper(change, coin):
        if change == 0:
            return 1
        elif change < 0:
            return 0
            ...
            with_coin = count_coins_helper(change - coin, coin)
            without_coin = count_coins_helper(change, next_smaller_coin(coin))
