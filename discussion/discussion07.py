...
class Server:
    ...
    def send(self, email):
        ...
        it is addressed to.
        """
        self.clients[email.recipient_name].inbox += [email]
...
class Keyboard:
    ...
    def press(self, pos):
        ...
        if pos in self.buttons:
            this_button = self.buttons[pos]
            this_button.times_pressed += 1
            return this_button.key
        return ''
